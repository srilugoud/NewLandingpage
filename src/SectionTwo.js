...
function SectionTwo({isDarkMode}){
    return(
        <>
      <div className={`sectiontwo ${isDarkMode ? "dark-mode" : "light-mode"}`}>
        <div className="containerrr">
        <div  className="row justify-content-center py-5 my-5 align-items-center">
        <div  className="col-xl-5 col-lg-6 col-md-12 cont">
    <div > 
        <p className="mb-0 spot text-justify m-spot" style={{color:"gray"}}>Pionex Futures-Spot Arbitrage</p>
        <p className="mb-0 usdt text-justify m-usdt" style={{color:"gray"}}>USDT Flexible Savings  </p>
        <p className="mb-0 height text-justify" style={{color:"white"}}>with <span style={{color:"#FF4F29"}}>the Highest APR in</span> 
         </p>
        <p className="mb-0 text-justify mar" style={{color:"gray"}}>the Market</p>
       <p className=" text-justify price mt-2">View Price comparisons <span><FaArrowRightLong size={22} /></span></p>
    </div>
    <div className="d-block d-lg-none mm-image">
      <img src={Image}/>
    </div>
    <div className="w-75 d-flex gap-3 flex-column mt-5">
    <div className="card p-3 shadow  border-0 carding  m-car" style={{backgroundColor:"#fafafa"}}>
...
<div className="col-xl-4 col-lg-6 col-md-12  d-none d-lg-block cont ">
