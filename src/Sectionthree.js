...
function SectionThree(){
    return(
        <>
        <div className="sectionthreee">
        <div  className="container" style={{padding:"10rem 0"}}>
                <div className="w-75 mx-auto">
        <p className="mb-0 security text-justify">
            Found Security
        </p>
        <p className="mb-0 principle text-justify">Pionex's Fundamental Principle</p>
        </div>
        ...
        <div>
           <p className="para">User assets are kept separate from operational <br/> funds, with Pionex maintaining a reserve ratio of <br/> over 100%. We use the 'Merkle Tree' auditing <br/> method to demonstrate a 100% reserve ratio.<br/>
